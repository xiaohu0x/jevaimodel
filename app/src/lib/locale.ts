...
export const UI_COPY: Record<Locale, UiCopy> = {
  en: {
    seo: {
      title: 'Free AI Text Classifier Online | JEV AI Model',
      description: 'Classify text and JSON online with AI. Get probabilities, scores, and labels in seconds. Try 3 free classifications without an account.',
      h1: 'Free online AI text classifier for structured decisions',
    ...
    hero: {
      eyebrow: 'ONLINE AI TEXT CLASSIFIER',
      lines: ['Free online AI text classifier', 'for structured decisions'],
      intro: 'Paste text or JSON, choose the answer format, and get a grounded classification with confidence scores.',
    },
    examples: {
  ...
  'zh-CN': {
    seo: {
      title: '免费 AI 文本分类器 - 在线文本分类工具 | JEV AI Model',
      description: '免费在线 AI 文本分类器，支持文本和 JSON。快速获得概率、评分与分类标签，无需注册即可免费试用 3 次。',
      h1: '免费在线 AI 文本分类器，把文本变成结构化结果',
    ...
    hero: {
      ...
      lines: ['免费在线 AI 文本分类器', '把文本变成结构化结果'],
  ...
  es: {
    seo: { title: 'Clasificador de texto con IA gratis y online | JEV', description: 'Clasifica texto y JSON con inteligencia artificial. Obtén probabilidades, puntuaciones y etiquetas en segundos. Prueba 3 clasificaciones gratis sin registrarte.', h1: 'Clasificador de texto con IA gratis para decisiones estructuradas', imageAlt: 'Clasificador de texto con IA gratis de JEV AI Model' },
    ...
    hero: { eyebrow: 'CLASIFICADOR DE TEXTO CON IA', lines: ['Clasificador de texto con IA gratis', 'para decisiones estructuradas'], intro: 'Pega texto o JSON, elige el formato de respuesta y obtén una clasificación fundamentada con nivel de confianza.' },
  ...
  ja: {
    seo: { title: '無料AIテキスト分類ツール・オンライン分類 | JEV', description: 'テキストやJSONをAIで無料分類。確率・スコア・ラベルを数秒で取得できます。アカウント登録なしで3回まで無料で試せます。', h1: '無料のAIテキスト分類ツールで結果を構造化', imageAlt: 'JEV AI Modelの無料AIテキスト分類ツール' },
    header: { playground: '分類ツール', howItWorks: '使い方', share: '共有', copied: 'コピー済み', signIn: 'ログイン', signOut: 'ログアウト', language: '言語' },
    hero: { eyebrow: 'オンラインAIテキスト分類', lines: ['無料のAIテキスト分類ツール', '判断結果を構造化'], intro: 'テキストやJSONを貼り付け、回答形式を選ぶだけ。確信度付きの分類結果をすぐに取得できます。' },
  ...
  ko: {
    seo: { title: '무료 AI 텍스트 분류기 - 온라인 분류 도구 | JEV', description: '텍스트와 JSON을 AI로 무료 분류하세요. 확률, 점수, 라벨을 몇 초 안에 확인할 수 있으며 가입 없이 3회 무료로 사용할 수 있습니다.', h1: '무료 AI 텍스트 분류기로 결과를 구조화하세요', imageAlt: 'JEV AI Model 무료 온라인 AI 텍스트 분류기' },
    header: { playground: '분류 도구', howItWorks: '사용 방법', share: '공유', copied: '복사됨', signIn: '로그인', signOut: '로그아웃', language: '언어' },
    hero: { eyebrow: '온라인 AI 텍스트 분류', lines: ['무료 AI 텍스트 분류기', '결과를 구조화하세요'], intro: '텍스트나 JSON을 붙여 넣고 답변 형식을 선택하면 신뢰도가 포함된 분류 결과를 받을 수 있습니다.' },
  ...
  fr: {
    seo: { title: 'Classificateur de texte IA gratuit en ligne | JEV', description: 'Classez du texte et du JSON avec l’IA. Obtenez probabilités, scores et étiquettes en quelques secondes. Essayez 3 classifications gratuites sans compte.', h1: 'Classificateur de texte IA gratuit pour des décisions structurées', imageAlt: 'Classificateur de texte IA gratuit JEV AI Model' },
    ...
    hero: { eyebrow: 'CLASSIFICATEUR DE TEXTE IA', lines: ['Classificateur de texte IA gratuit', 'pour des décisions structurées'], intro: 'Collez du texte ou du JSON, choisissez le format de réponse et obtenez une classification justifiée avec son niveau de confiance.' },
  ...
  de: {
    seo: { title: 'Kostenloser KI-Textklassifikator online | JEV', description: 'Text und JSON kostenlos mit KI klassifizieren. Erhalte Wahrscheinlichkeiten, Bewertungen und Labels in Sekunden. 3 Tests ohne Anmeldung.', h1: 'Kostenloser KI-Textklassifikator für strukturierte Entscheidungen', imageAlt: 'Kostenloser KI-Textklassifikator von JEV AI Model' },
    ...
    hero: { eyebrow: 'ONLINE KI-TEXTKLASSIFIKATOR', lines: ['Kostenloser KI-Textklassifikator', 'für strukturierte Entscheidungen'], intro: 'Text oder JSON einfügen, Antwortformat wählen und eine nachvollziehbare Klassifikation mit Konfidenz erhalten.' },
  ...
  'pt-BR': {
    seo: { title: 'Classificador de texto com IA grátis online | JEV', description: 'Classifique texto e JSON com inteligência artificial. Receba probabilidades, notas e rótulos em segundos. Teste 3 classificações grátis sem cadastro.', h1: 'Classificador de texto com IA grátis para decisões estruturadas', imageAlt: 'Classificador de texto com IA grátis do JEV AI Model' },
    ...
    hero: { eyebrow: 'CLASSIFICADOR DE TEXTO COM IA', lines: ['Classificador de texto com IA grátis', 'para decisões estruturadas'], intro: 'Cole texto ou JSON, escolha o formato da resposta e receba uma classificação fundamentada com nível de confiança.' },
